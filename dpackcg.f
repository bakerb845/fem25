...
C*
        subroutine dcg(n,b,x,r,z,p,q,D,E,aux,
...
*
        zalpha = alpha*DONE
        call daxpy(n,zalpha,p,1,x,1)
        call daxpy(n,-zalpha,q,1,r,1)
*
        if (iest.eq.1) then
         if (iter.gt.1) then
...
*
        ...
        subroutine drive_dcg(n,nloc,lwork,work,
     &                         irc,icntl,cntl,info,rinfo)
*
*  Purpose
*  =======
...
*
*
       call dcg(nloc,work(bptr),work(xptr),
...
*
       return
        ...
        subroutine init_dcg(icntl,cntl)
*
*  Purpose
*  =======
